  ...
  <div class="container-fluid">
    ...
    <div class="container-fluid">
        ...
        <div class="card" style="">
            ...
            <div class="row">
            <div class="col-md-3">
            <a href="{{route('admin.blood_donor.create')}}" type="button" class="btn btn-success">নতুন যোগ করুন </a>
            </div>
        </div>
        </div>
        <div class="card-body">
        <table class="table table-bordered" id="example1">
            ...
            <tbody >
                ...
                <td>
                    ...
                    <form id="delete-form-{{ $categorie->id }}" action="{{ route('admin.blood_donor.delete',$categorie->id) }}" method="POST" style="display: none;">
                    @csrf
                    </form>
                    <a href="{{ route('admin.blood_donor.edit',$categorie->id) }}" type="button" class="btn btn-info text-light"><i class="fas fa-edit"></i></a>
