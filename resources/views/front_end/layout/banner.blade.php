                  ...
                  <form method="get" action="{{route('search_doctor')}}">
                    <div class="row " style="font-family: 'Open Sans', sans-serif;">
                        ...
                        <div class="col-7 col-md-7 small_screen_padding">
                            <select id="payments" name="search" style="font-family: bangla;background-color: #E2F1F6 !impotant;box-shadow: 0px 1px 3px 0px grey;"  class="form-select form-control select_width_samll_device" aria-label="Default select example">
                                <option style="font: size 33px;" data-description="" data-image="{{asset('/')}}public/front_end/img/down_arrow.png" >&nbsp;বিভাগ  বাছাই করুন </option>
